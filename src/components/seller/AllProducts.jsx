...
const AllProducts = () => {
  ...
  //https://demos.creative-tim.com/soft-ui-flowbite-pro/e-commerce/products/
  ...
  return (
    <main>
      <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        <div className="w-full mb-1">
          ...
          <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            ...
            <SfButton onClick={() => setOpen(true)}> Add new product</SfButton>
          </div>
        </div>
      </div>
                ...
                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                  <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                      ...
                      Consequatur excepturi doloremque in perferendis ab ipsum!
                      Molestiae possimus blanditiis quis placeat, maxime
                      molestias?
                    </td>
                    <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      #194556
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="AN">Clothes</option>
      ...
      <SfDrawer
        ...
        placement={"right"}
        className={classNames("bg-neutral-50 p-3 border border-gray-300 z-50", {
          "max-w-[370px]": "right",
        })}
      >
        <h5
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="10">10%</option>
                <option value="20">20%</option>
                <option value="30">30%</option>A<option value="40">40%</option>
                <option value="50">50%</option>
              </select>
            </div>
