...
const Dashboard = () => {
  return (
    <div>
      ...
      <div className="px-4 mx-auto w-full mb-8">
        <div>
      ...
      <div className="relative min-w-0 break-words bg-white w-full mb-6  rounded grid grid-cols-8 gap-5">
        ...
        <div className="col-span-3 lg:col-span-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded  px-4">
          ...
          <div className="w-full rounded-lg border border-stroke bg-white dark:border-dark-3 dark:bg-dark-2">
            <div className="max-w-full overflow-x-auto ">
              <table className="w-full table-auto">
                ...
                <tbody>
                  <tr className="border-b border-stroke last-of-type:border-none dark:border-dark-3">
      ...
      <div className="grid grid-cols-7 gap-5">
        <div className="col-span-4 lg:col-span-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
          <div className="rounded-t mb-0 px-4 py-3 border-0">
            <div className="flex flex-wrap items-center">
              <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                <h3 className="font-semibold text-base text-blueGray-700">
            ...
            <tbody className="text-gray-600">
              <tr>
                ...
                <td className="border border-l-0 border-r-0 px-4 py-2">
                  <span className="num-2">7</span> minutes ago
                </td>
              </tr>
              <tr>
                ...
                <td className="border border-l-0 px-4 py-2">
                  $<span className="num-2">69</span>
                </td>
                <td className="border border-l-0 border-r-0 px-4 py-2">
                  <span className="num-2">35</span> minutes ago
                </td>
              </tr>
              <tr>
                <td className="border border-l-0 px-4 py-2 text-center text-green-500">
                ...
                <td className="border border-l-0 px-4 py-2">
                  $<span className="num-2">70</span>
                </td>
                <td className="border border-l-0 border-r-0 px-4 py-2">
                  <span className="num-2">49</span> minutes ago
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border border-l-0 px-4 py-2">
                  $<span className="num-2">52</span>
                </td>
                <td className="border border-l-0 border-r-0 px-4 py-2">
                  <span className="num-2">20</span> minutes ago
                </td>
              </tr>
              <tr>
                ...
                <td className="border border-l-0 border-b-0 px-4 py-2">
                  $<span className="num-2">78</span>
                </td>
                <td className="border border-l-0 border-b-0 border-r-0 px-4 py-2">
                  <span className="num-2">70</span> minutes ago
                </td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="col-span-2 lg:col-span-3 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
          <div className="rounded-t mb-0 px-4 py-3 border-0">
            <div className="flex flex-wrap items-center">
              <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                <h3 className="font-semibold text-base text-blueGray-700">
