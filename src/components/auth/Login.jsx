...
const Login = () => {
  const { googleSignIn, login, error } = useContext(AuthContext);
  ...
  return (
    <div className="flex h-screen">
        ...
        <div className="text-center">
          ...
          >
            ...
            <path
              ...
              fill="#ccc"
            />
            <circle cx="524.99994" cy="335.5" r="16" fill="#000000" />
            <polygon
      ...
      <Link
        to="/"
        className="absolute block rounded-lg right-10 top-5 bg-indigo-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-indigo-700 focus:outline-none focus:ring"
        type="button"
      >
        Skip
      </Link>
